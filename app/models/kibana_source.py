...
class KibanaSource(Base, TimestampMixin, table=True):
    __tablename__ = "kibana_sources"
    ...
    data_source: "DataSource" = Relationship(back_populates="kibana_sources")
